...
router.get('/:recordid/edit', function (req, res, next) {
    let query = "SELECT firstname,middlename,lastname,email,phone,address1,address2,city,state,zip,username,password FROM customer WHERE customer_id = " + req.params.recordid;
